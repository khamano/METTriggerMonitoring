...
#cmt_local_tagfile_check_install_python_modules = $(TrigCostMonitor_tag)_check_install_python_modules.make
...
#cmt_local_tagfile_check_install_python_modules = $(TrigCostMonitor_tag).make
...
#cmt_final_setup_check_install_python_modules = $(bin)TrigCostMonitor_check_install_python_modulessetup.make
...
#cmt_final_setup_check_install_python_modules = $(bin)TrigCostMonitorsetup.make
cmt_local_check_install_python_modules_makefile = $(bin)check_install_python_modules.make
...
$(check_install_python_modulesactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.3.5/AtlasCore/20.3.5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../python TrigCost*.py ' -installdir=/afs/cern.ch/user/r/rewang/public/cmthome/InstallArea/python/TrigCostMonitor -level=
