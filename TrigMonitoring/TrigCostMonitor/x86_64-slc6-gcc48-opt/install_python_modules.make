...
#cmt_local_tagfile_install_python_modules = $(TrigCostMonitor_tag)_install_python_modules.make
...
#cmt_local_tagfile_install_python_modules = $(TrigCostMonitor_tag).make
...
#cmt_final_setup_install_python_modules = $(bin)TrigCostMonitor_install_python_modulessetup.make
...
#cmt_final_setup_install_python_modules = $(bin)TrigCostMonitorsetup.make
cmt_local_install_python_modules_makefile = $(bin)install_python_modules.make
...
install_dir = ${installarea}/python/TrigCostMonitor
...
TrigCostMonitorConfig_py_dependencies = ../python/TrigCostMonitorConfig.py


install_python_modulesinstall :: ${install_dir}/TrigCostMonitorConfig.py
	@if test ! "${installarea}" = ""; then\
	  echo "installation done"; \
	fi

${install_dir}/TrigCostMonitorConfig.py :: ../python/TrigCostMonitorConfig.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../python/TrigCostMonitorConfig.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "TrigCostMonitorConfig.py" "$(install_dir)" "ln -sf" "$($(package)_cmtpath)"; \
	fi

../python/TrigCostMonitorConfig.py : ;
...
install_python_modulesuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "TrigCostMonitorConfig.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi
