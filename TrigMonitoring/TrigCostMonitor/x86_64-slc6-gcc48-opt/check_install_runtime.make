...
#cmt_local_tagfile_check_install_runtime = $(TrigCostMonitor_tag)_check_install_runtime.make
...
#cmt_local_tagfile_check_install_runtime = $(TrigCostMonitor_tag).make
...
#cmt_final_setup_check_install_runtime = $(bin)TrigCostMonitor_check_install_runtimesetup.make
...
#cmt_final_setup_check_install_runtime = $(bin)TrigCostMonitorsetup.make
cmt_local_check_install_runtime_makefile = $(bin)check_install_runtime.make
...
$(check_install_runtimeactionstamp) ::
	$(silent) /cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.3.5/AtlasCore/20.3.5/External/ExternalPolicy/cmt/atlas_check_installations.sh -files=' -s=../share  ../share/*.xml ' -installdir=/afs/cern.ch/user/r/rewang/public/cmthome/InstallArea/share -level=
