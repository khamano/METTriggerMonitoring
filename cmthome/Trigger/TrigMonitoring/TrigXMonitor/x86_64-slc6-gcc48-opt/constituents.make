...
#cmt_local_tagfile = $(TrigXMonitor_tag).make
cmt_local_tagfile = $(bin)$(TrigXMonitor_tag).make
...
cmt_TrigXMonitorrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_TrigXMonitorrchk_has_target_tag

cmt_local_tagfile_TrigXMonitorrchk = $(bin)$(TrigXMonitor_tag)_TrigXMonitorrchk.make
cmt_final_setup_TrigXMonitorrchk = $(bin)setup_TrigXMonitorrchk.make
cmt_local_TrigXMonitorrchk_makefile = $(bin)TrigXMonitorrchk.make

TrigXMonitorrchk_extratags = -tag_add=target_TrigXMonitorrchk

else

cmt_local_tagfile_TrigXMonitorrchk = $(bin)$(TrigXMonitor_tag).make
cmt_final_setup_TrigXMonitorrchk = $(bin)setup.make
cmt_local_TrigXMonitorrchk_makefile = $(bin)TrigXMonitorrchk.make

endif

not_TrigXMonitorrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(TrigXMonitorrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TrigXMonitorrchkdirs :
	@if test ! -d $(bin)TrigXMonitorrchk; then $(mkdir) -p $(bin)TrigXMonitorrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TrigXMonitorrchk
else
TrigXMonitorrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TrigXMonitorrchk_makefile) : $(TrigXMonitorrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building TrigXMonitorrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(TrigXMonitorrchk_extratags) build constituent_config -out=$(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchk
else
$(cmt_local_TrigXMonitorrchk_makefile) : $(TrigXMonitorrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TrigXMonitorrchk) ] || \
	  [ ! -f $(cmt_final_setup_TrigXMonitorrchk) ] || \
	  $(not_TrigXMonitorrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TrigXMonitorrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(TrigXMonitorrchk_extratags) build constituent_config -out=$(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchk; \
	  fi
endif
...
$(cmt_local_TrigXMonitorrchk_makefile) : $(TrigXMonitorrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building TrigXMonitorrchk.make"; \
	  $(cmtexe) -f=$(bin)TrigXMonitorrchk.in -tag=$(tags) $(TrigXMonitorrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchk
else
$(cmt_local_TrigXMonitorrchk_makefile) : $(TrigXMonitorrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)TrigXMonitorrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TrigXMonitorrchk) ] || \
	  [ ! -f $(cmt_final_setup_TrigXMonitorrchk) ] || \
	  $(not_TrigXMonitorrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TrigXMonitorrchk_extratags) build constituent_makefile -out=$(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchk

TrigXMonitorrchk :: $(TrigXMonitorrchk_dependencies) $(cmt_local_TrigXMonitorrchk_makefile) dirs TrigXMonitorrchkdirs
	$(echo) "(constituents.make) Starting TrigXMonitorrchk"
	@if test -f $(cmt_local_TrigXMonitorrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchk
	$(echo) "(constituents.make) TrigXMonitorrchk done"

clean :: TrigXMonitorrchkclean ;

TrigXMonitorrchkclean :: $(TrigXMonitorrchkclean_dependencies) ##$(cmt_local_TrigXMonitorrchk_makefile)
	$(echo) "(constituents.make) Starting TrigXMonitorrchkclean"
	@-if test -f $(cmt_local_TrigXMonitorrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchkclean; \
	fi
	$(echo) "(constituents.make) TrigXMonitorrchkclean done"
#	@-$(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) TrigXMonitorrchkclean

##	  /bin/rm -f $(cmt_local_TrigXMonitorrchk_makefile) $(bin)TrigXMonitorrchk_dependencies.make

install :: TrigXMonitorrchkinstall ;

TrigXMonitorrchkinstall :: $(TrigXMonitorrchk_dependencies) $(cmt_local_TrigXMonitorrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TrigXMonitorrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TrigXMonitorrchkuninstall

$(foreach d,$(TrigXMonitorrchk_dependencies),$(eval $(d)uninstall_dependencies += TrigXMonitorrchkuninstall))

TrigXMonitorrchkuninstall : $(TrigXMonitorrchkuninstall_dependencies) ##$(cmt_local_TrigXMonitorrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TrigXMonitorrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TrigXMonitorrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TrigXMonitorrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(TrigXMonitor_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(TrigXMonitor_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_make = $(bin)$(TrigXMonitor_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(TrigXMonitor_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(TrigXMonitor_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(TrigXMonitor_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(TrigXMonitor_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(TrigXMonitor_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(TrigXMonitor_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(TrigXMonitor_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(TrigXMonitor_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(TrigXMonitor_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(TrigXMonitor_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(TrigXMonitor_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(TrigXMonitor_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(TrigXMonitor_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(TrigXMonitor_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_find_packages = $(bin)$(TrigXMonitor_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_compile = $(bin)$(TrigXMonitor_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(TrigXMonitor_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(TrigXMonitor_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(TrigXMonitor_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(TrigXMonitor_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(TrigXMonitor_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(TrigXMonitor_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(TrigXMonitor_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(TrigXMonitor_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(TrigXMonitor_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(TrigXMonitor_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(TrigXMonitor_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(TrigXMonitor_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(TrigXMonitor_tag).make
