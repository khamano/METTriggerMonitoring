...
#cmt_local_tagfile = $(TrigCostPython_tag).make
cmt_local_tagfile = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_install_python_modules = $(bin)$(TrigCostPython_tag)_install_python_modules.make
...
cmt_local_tagfile_install_python_modules = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_install_joboptions = $(bin)$(TrigCostPython_tag)_install_joboptions.make
...
cmt_local_tagfile_install_joboptions = $(bin)$(TrigCostPython_tag).make
...
install_data_extratags = -tag_add=target_install_data
...
not_install_data_dependencies = { n=0; for p in $?; do m=0; for d in $(install_data_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
install_datadirs :
	@if test ! -d $(bin)install_data; then $(mkdir) -p $(bin)install_data; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)install_data
else
install_datadirs : ;
endif
...
ifndef QUICK
$(cmt_local_install_data_makefile) : $(install_data_dependencies) build_library_links
	$(echo) "(constituents.make) Building install_data.make"; \
	  $(cmtexe) -tag=$(tags) $(install_data_extratags) build constituent_config -out=$(cmt_local_install_data_makefile) install_data
else
$(cmt_local_install_data_makefile) : $(install_data_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_install_data) ] || \
	  [ ! -f $(cmt_final_setup_install_data) ] || \
	  $(not_install_data_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building install_data.make"; \
	  $(cmtexe) -tag=$(tags) $(install_data_extratags) build constituent_config -out=$(cmt_local_install_data_makefile) install_data; \
	  fi
endif
...
$(cmt_local_install_data_makefile) : $(install_data_dependencies) build_library_links
	$(echo) "(constituents.make) Building install_data.make"; \
	  $(cmtexe) -f=$(bin)install_data.in -tag=$(tags) $(install_data_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_install_data_makefile) install_data
else
$(cmt_local_install_data_makefile) : $(install_data_dependencies) $(cmt_build_library_linksstamp) $(bin)install_data.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_install_data) ] || \
	  [ ! -f $(cmt_final_setup_install_data) ] || \
	  $(not_install_data_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(install_data_extratags) build constituent_makefile -out=$(cmt_local_install_data_makefile) install_data

install_data :: $(install_data_dependencies) $(cmt_local_install_data_makefile) dirs install_datadirs
	$(echo) "(constituents.make) Starting install_data"
	@if test -f $(cmt_local_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_install_data_makefile) install_data; \
	  fi
#	@$(MAKE) -f $(cmt_local_install_data_makefile) install_data
	$(echo) "(constituents.make) install_data done"

clean :: install_dataclean ;

install_dataclean :: $(install_dataclean_dependencies) ##$(cmt_local_install_data_makefile)
	$(echo) "(constituents.make) Starting install_dataclean"
	@-if test -f $(cmt_local_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_install_data_makefile) install_dataclean; \
	fi
	$(echo) "(constituents.make) install_dataclean done"
#	@-$(MAKE) -f $(cmt_local_install_data_makefile) install_dataclean

##	  /bin/rm -f $(cmt_local_install_data_makefile) $(bin)install_data_dependencies.make

install :: install_datainstall ;

install_datainstall :: $(install_data_dependencies) $(cmt_local_install_data_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_install_data_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_install_data_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(install_data_dependencies),$(eval $(d)uninstall_dependencies += install_datauninstall))

install_datauninstall : $(install_datauninstall_dependencies) ##$(cmt_local_install_data_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_install_data_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_install_data_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: install_datauninstall ;
...
install_binaries_extratags = -tag_add=target_install_binaries
...
not_install_binaries_dependencies = { n=0; for p in $?; do m=0; for d in $(install_binaries_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
install_binariesdirs :
	@if test ! -d $(bin)install_binaries; then $(mkdir) -p $(bin)install_binaries; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)install_binaries
else
install_binariesdirs : ;
endif
...
ifndef QUICK
$(cmt_local_install_binaries_makefile) : $(install_binaries_dependencies) build_library_links
	$(echo) "(constituents.make) Building install_binaries.make"; \
	  $(cmtexe) -tag=$(tags) $(install_binaries_extratags) build constituent_config -out=$(cmt_local_install_binaries_makefile) install_binaries
else
$(cmt_local_install_binaries_makefile) : $(install_binaries_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_install_binaries) ] || \
	  [ ! -f $(cmt_final_setup_install_binaries) ] || \
	  $(not_install_binaries_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building install_binaries.make"; \
	  $(cmtexe) -tag=$(tags) $(install_binaries_extratags) build constituent_config -out=$(cmt_local_install_binaries_makefile) install_binaries; \
	  fi
endif
...
$(cmt_local_install_binaries_makefile) : $(install_binaries_dependencies) build_library_links
	$(echo) "(constituents.make) Building install_binaries.make"; \
	  $(cmtexe) -f=$(bin)install_binaries.in -tag=$(tags) $(install_binaries_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_install_binaries_makefile) install_binaries
else
$(cmt_local_install_binaries_makefile) : $(install_binaries_dependencies) $(cmt_build_library_linksstamp) $(bin)install_binaries.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_install_binaries) ] || \
	  [ ! -f $(cmt_final_setup_install_binaries) ] || \
	  $(not_install_binaries_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(install_binaries_extratags) build constituent_makefile -out=$(cmt_local_install_binaries_makefile) install_binaries

install_binaries :: $(install_binaries_dependencies) $(cmt_local_install_binaries_makefile) dirs install_binariesdirs
	$(echo) "(constituents.make) Starting install_binaries"
	@if test -f $(cmt_local_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_install_binaries_makefile) install_binaries; \
	  fi
#	@$(MAKE) -f $(cmt_local_install_binaries_makefile) install_binaries
	$(echo) "(constituents.make) install_binaries done"

clean :: install_binariesclean ;

install_binariesclean :: $(install_binariesclean_dependencies) ##$(cmt_local_install_binaries_makefile)
	$(echo) "(constituents.make) Starting install_binariesclean"
	@-if test -f $(cmt_local_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_install_binaries_makefile) install_binariesclean; \
	fi
	$(echo) "(constituents.make) install_binariesclean done"
#	@-$(MAKE) -f $(cmt_local_install_binaries_makefile) install_binariesclean

##	  /bin/rm -f $(cmt_local_install_binaries_makefile) $(bin)install_binaries_dependencies.make

install :: install_binariesinstall ;

install_binariesinstall :: $(install_binaries_dependencies) $(cmt_local_install_binaries_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_install_binaries_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_install_binaries_makefile) install
	$(echo) "(constituents.make) $@ done"
...
$(foreach d,$(install_binaries_dependencies),$(eval $(d)uninstall_dependencies += install_binariesuninstall))

install_binariesuninstall : $(install_binariesuninstall_dependencies) ##$(cmt_local_install_binaries_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_install_binaries_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_install_binaries_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: install_binariesuninstall ;
...
cmt_TrigCostPythonrchk_has_target_tag = 1

#--------------------------------------

ifdef cmt_TrigCostPythonrchk_has_target_tag

cmt_local_tagfile_TrigCostPythonrchk = $(bin)$(TrigCostPython_tag)_TrigCostPythonrchk.make
cmt_final_setup_TrigCostPythonrchk = $(bin)setup_TrigCostPythonrchk.make
cmt_local_TrigCostPythonrchk_makefile = $(bin)TrigCostPythonrchk.make

TrigCostPythonrchk_extratags = -tag_add=target_TrigCostPythonrchk

else

cmt_local_tagfile_TrigCostPythonrchk = $(bin)$(TrigCostPython_tag).make
cmt_final_setup_TrigCostPythonrchk = $(bin)setup.make
cmt_local_TrigCostPythonrchk_makefile = $(bin)TrigCostPythonrchk.make

endif

not_TrigCostPythonrchk_dependencies = { n=0; for p in $?; do m=0; for d in $(TrigCostPythonrchk_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
TrigCostPythonrchkdirs :
	@if test ! -d $(bin)TrigCostPythonrchk; then $(mkdir) -p $(bin)TrigCostPythonrchk; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)TrigCostPythonrchk
else
TrigCostPythonrchkdirs : ;
endif
...
ifndef QUICK
$(cmt_local_TrigCostPythonrchk_makefile) : $(TrigCostPythonrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building TrigCostPythonrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(TrigCostPythonrchk_extratags) build constituent_config -out=$(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchk
else
$(cmt_local_TrigCostPythonrchk_makefile) : $(TrigCostPythonrchk_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TrigCostPythonrchk) ] || \
	  [ ! -f $(cmt_final_setup_TrigCostPythonrchk) ] || \
	  $(not_TrigCostPythonrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building TrigCostPythonrchk.make"; \
	  $(cmtexe) -tag=$(tags) $(TrigCostPythonrchk_extratags) build constituent_config -out=$(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchk; \
	  fi
endif
...
$(cmt_local_TrigCostPythonrchk_makefile) : $(TrigCostPythonrchk_dependencies) build_library_links
	$(echo) "(constituents.make) Building TrigCostPythonrchk.make"; \
	  $(cmtexe) -f=$(bin)TrigCostPythonrchk.in -tag=$(tags) $(TrigCostPythonrchk_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchk
else
$(cmt_local_TrigCostPythonrchk_makefile) : $(TrigCostPythonrchk_dependencies) $(cmt_build_library_linksstamp) $(bin)TrigCostPythonrchk.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_TrigCostPythonrchk) ] || \
	  [ ! -f $(cmt_final_setup_TrigCostPythonrchk) ] || \
	  $(not_TrigCostPythonrchk_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(TrigCostPythonrchk_extratags) build constituent_makefile -out=$(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchk

TrigCostPythonrchk :: $(TrigCostPythonrchk_dependencies) $(cmt_local_TrigCostPythonrchk_makefile) dirs TrigCostPythonrchkdirs
	$(echo) "(constituents.make) Starting TrigCostPythonrchk"
	@if test -f $(cmt_local_TrigCostPythonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchk; \
	  fi
#	@$(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchk
	$(echo) "(constituents.make) TrigCostPythonrchk done"

clean :: TrigCostPythonrchkclean ;

TrigCostPythonrchkclean :: $(TrigCostPythonrchkclean_dependencies) ##$(cmt_local_TrigCostPythonrchk_makefile)
	$(echo) "(constituents.make) Starting TrigCostPythonrchkclean"
	@-if test -f $(cmt_local_TrigCostPythonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchkclean; \
	fi
	$(echo) "(constituents.make) TrigCostPythonrchkclean done"
#	@-$(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) TrigCostPythonrchkclean

##	  /bin/rm -f $(cmt_local_TrigCostPythonrchk_makefile) $(bin)TrigCostPythonrchk_dependencies.make

install :: TrigCostPythonrchkinstall ;

TrigCostPythonrchkinstall :: $(TrigCostPythonrchk_dependencies) $(cmt_local_TrigCostPythonrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_TrigCostPythonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : TrigCostPythonrchkuninstall

$(foreach d,$(TrigCostPythonrchk_dependencies),$(eval $(d)uninstall_dependencies += TrigCostPythonrchkuninstall))

TrigCostPythonrchkuninstall : $(TrigCostPythonrchkuninstall_dependencies) ##$(cmt_local_TrigCostPythonrchk_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_TrigCostPythonrchk_makefile); then \
	  $(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_TrigCostPythonrchk_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: TrigCostPythonrchkuninstall ;
...
cmt_local_tagfile_install_root_include_path = $(bin)$(TrigCostPython_tag)_install_root_include_path.make
...
cmt_local_tagfile_install_root_include_path = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_install_includes = $(bin)$(TrigCostPython_tag)_install_includes.make
...
cmt_local_tagfile_install_includes = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_make = $(bin)$(TrigCostPython_tag)_make.make
...
cmt_local_tagfile_make = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_CompilePython = $(bin)$(TrigCostPython_tag)_CompilePython.make
...
cmt_local_tagfile_CompilePython = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_qmtest_run = $(bin)$(TrigCostPython_tag)_qmtest_run.make
...
cmt_local_tagfile_qmtest_run = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(TrigCostPython_tag)_qmtest_summarize.make
...
cmt_local_tagfile_qmtest_summarize = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_TestPackage = $(bin)$(TrigCostPython_tag)_TestPackage.make
...
cmt_local_tagfile_TestPackage = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_TestProject = $(bin)$(TrigCostPython_tag)_TestProject.make
...
cmt_local_tagfile_TestProject = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_rootsys = $(bin)$(TrigCostPython_tag)_new_rootsys.make
...
cmt_local_tagfile_new_rootsys = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_doxygen = $(bin)$(TrigCostPython_tag)_doxygen.make
...
cmt_local_tagfile_doxygen = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_post_install = $(bin)$(TrigCostPython_tag)_post_install.make
...
cmt_local_tagfile_post_install = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(TrigCostPython_tag)_post_merge_rootmap.make
...
cmt_local_tagfile_post_merge_rootmap = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(TrigCostPython_tag)_post_merge_genconfdb.make
...
cmt_local_tagfile_post_merge_genconfdb = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(TrigCostPython_tag)_post_build_tpcnvdb.make
...
cmt_local_tagfile_post_build_tpcnvdb = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(TrigCostPython_tag)_all_post_constituents.make
...
cmt_local_tagfile_all_post_constituents = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_checkreq = $(bin)$(TrigCostPython_tag)_checkreq.make
...
cmt_local_tagfile_checkreq = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(TrigCostPython_tag)_check_install_python_modules.make
...
cmt_local_tagfile_check_install_python_modules = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(TrigCostPython_tag)_check_install_joboptions.make
...
cmt_local_tagfile_check_install_joboptions = $(bin)$(TrigCostPython_tag).make
...
check_install_data_extratags = -tag_add=target_check_install_data
...
not_check_install_data_dependencies = { n=0; for p in $?; do m=0; for d in $(check_install_data_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
check_install_datadirs :
	@if test ! -d $(bin)check_install_data; then $(mkdir) -p $(bin)check_install_data; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)check_install_data
else
check_install_datadirs : ;
endif
...
ifndef QUICK
$(cmt_local_check_install_data_makefile) : $(check_install_data_dependencies) build_library_links
	$(echo) "(constituents.make) Building check_install_data.make"; \
	  $(cmtexe) -tag=$(tags) $(check_install_data_extratags) build constituent_config -out=$(cmt_local_check_install_data_makefile) check_install_data
else
$(cmt_local_check_install_data_makefile) : $(check_install_data_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_check_install_data) ] || \
	  [ ! -f $(cmt_final_setup_check_install_data) ] || \
	  $(not_check_install_data_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building check_install_data.make"; \
	  $(cmtexe) -tag=$(tags) $(check_install_data_extratags) build constituent_config -out=$(cmt_local_check_install_data_makefile) check_install_data; \
	  fi
endif
...
$(cmt_local_check_install_data_makefile) : $(check_install_data_dependencies) build_library_links
	$(echo) "(constituents.make) Building check_install_data.make"; \
	  $(cmtexe) -f=$(bin)check_install_data.in -tag=$(tags) $(check_install_data_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_check_install_data_makefile) check_install_data
else
$(cmt_local_check_install_data_makefile) : $(check_install_data_dependencies) $(cmt_build_library_linksstamp) $(bin)check_install_data.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_check_install_data) ] || \
	  [ ! -f $(cmt_final_setup_check_install_data) ] || \
	  $(not_check_install_data_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(check_install_data_extratags) build constituent_makefile -out=$(cmt_local_check_install_data_makefile) check_install_data

check_install_data :: $(check_install_data_dependencies) $(cmt_local_check_install_data_makefile) dirs check_install_datadirs
	$(echo) "(constituents.make) Starting check_install_data"
	@if test -f $(cmt_local_check_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_data_makefile) check_install_data; \
	  fi
#	@$(MAKE) -f $(cmt_local_check_install_data_makefile) check_install_data
	$(echo) "(constituents.make) check_install_data done"

clean :: check_install_dataclean ;

check_install_dataclean :: $(check_install_dataclean_dependencies) ##$(cmt_local_check_install_data_makefile)
	$(echo) "(constituents.make) Starting check_install_dataclean"
	@-if test -f $(cmt_local_check_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_data_makefile) check_install_dataclean; \
	fi
	$(echo) "(constituents.make) check_install_dataclean done"
#	@-$(MAKE) -f $(cmt_local_check_install_data_makefile) check_install_dataclean

##	  /bin/rm -f $(cmt_local_check_install_data_makefile) $(bin)check_install_data_dependencies.make

install :: check_install_datainstall ;

check_install_datainstall :: $(check_install_data_dependencies) $(cmt_local_check_install_data_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_check_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_data_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_check_install_data_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : check_install_datauninstall

$(foreach d,$(check_install_data_dependencies),$(eval $(d)uninstall_dependencies += check_install_datauninstall))

check_install_datauninstall : $(check_install_datauninstall_dependencies) ##$(cmt_local_check_install_data_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_check_install_data_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_data_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_check_install_data_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: check_install_datauninstall ;
...
cmt_check_install_binaries_has_no_target_tag = 1

#--------------------------------------

ifdef cmt_check_install_binaries_has_target_tag

cmt_local_tagfile_check_install_binaries = $(bin)$(TrigCostPython_tag)_check_install_binaries.make
cmt_final_setup_check_install_binaries = $(bin)setup_check_install_binaries.make
cmt_local_check_install_binaries_makefile = $(bin)check_install_binaries.make

check_install_binaries_extratags = -tag_add=target_check_install_binaries

else

cmt_local_tagfile_check_install_binaries = $(bin)$(TrigCostPython_tag).make
cmt_final_setup_check_install_binaries = $(bin)setup.make
cmt_local_check_install_binaries_makefile = $(bin)check_install_binaries.make

endif

not_check_install_binaries_dependencies = { n=0; for p in $?; do m=0; for d in $(check_install_binaries_dependencies); do if [ $$p = $$d ]; then m=1; break; fi; done; if [ $$m -eq 0 ]; then n=1; break; fi; done; [ $$n -eq 1 ]; }

ifdef STRUCTURED_OUTPUT
check_install_binariesdirs :
	@if test ! -d $(bin)check_install_binaries; then $(mkdir) -p $(bin)check_install_binaries; fi
	$(echo) "STRUCTURED_OUTPUT="$(bin)check_install_binaries
else
check_install_binariesdirs : ;
endif
...
ifndef QUICK
$(cmt_local_check_install_binaries_makefile) : $(check_install_binaries_dependencies) build_library_links
	$(echo) "(constituents.make) Building check_install_binaries.make"; \
	  $(cmtexe) -tag=$(tags) $(check_install_binaries_extratags) build constituent_config -out=$(cmt_local_check_install_binaries_makefile) check_install_binaries
else
$(cmt_local_check_install_binaries_makefile) : $(check_install_binaries_dependencies) $(cmt_build_library_linksstamp) $(use_requirements)
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_check_install_binaries) ] || \
	  [ ! -f $(cmt_final_setup_check_install_binaries) ] || \
	  $(not_check_install_binaries_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
	  echo "$(CMTMSGPREFIX)" "(constituents.make) Building check_install_binaries.make"; \
	  $(cmtexe) -tag=$(tags) $(check_install_binaries_extratags) build constituent_config -out=$(cmt_local_check_install_binaries_makefile) check_install_binaries; \
	  fi
endif
...
$(cmt_local_check_install_binaries_makefile) : $(check_install_binaries_dependencies) build_library_links
	$(echo) "(constituents.make) Building check_install_binaries.make"; \
	  $(cmtexe) -f=$(bin)check_install_binaries.in -tag=$(tags) $(check_install_binaries_extratags) build constituent_makefile -without_cmt -out=$(cmt_local_check_install_binaries_makefile) check_install_binaries
else
$(cmt_local_check_install_binaries_makefile) : $(check_install_binaries_dependencies) $(cmt_build_library_linksstamp) $(bin)check_install_binaries.in
	@if [ ! -f $@ ] || [ ! -f $(cmt_local_tagfile_check_install_binaries) ] || \
	  [ ! -f $(cmt_final_setup_check_install_binaries) ] || \
	  $(not_check_install_binaries_dependencies) ; then \
	  test -z "$(cmtmsg)" || \
...
#	  $(cmtexe) -tag=$(tags) $(check_install_binaries_extratags) build constituent_makefile -out=$(cmt_local_check_install_binaries_makefile) check_install_binaries

check_install_binaries :: $(check_install_binaries_dependencies) $(cmt_local_check_install_binaries_makefile) dirs check_install_binariesdirs
	$(echo) "(constituents.make) Starting check_install_binaries"
	@if test -f $(cmt_local_check_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_binaries_makefile) check_install_binaries; \
	  fi
#	@$(MAKE) -f $(cmt_local_check_install_binaries_makefile) check_install_binaries
	$(echo) "(constituents.make) check_install_binaries done"

clean :: check_install_binariesclean ;

check_install_binariesclean :: $(check_install_binariesclean_dependencies) ##$(cmt_local_check_install_binaries_makefile)
	$(echo) "(constituents.make) Starting check_install_binariesclean"
	@-if test -f $(cmt_local_check_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_binaries_makefile) check_install_binariesclean; \
	fi
	$(echo) "(constituents.make) check_install_binariesclean done"
#	@-$(MAKE) -f $(cmt_local_check_install_binaries_makefile) check_install_binariesclean

##	  /bin/rm -f $(cmt_local_check_install_binaries_makefile) $(bin)check_install_binaries_dependencies.make

install :: check_install_binariesinstall ;

check_install_binariesinstall :: $(check_install_binaries_dependencies) $(cmt_local_check_install_binaries_makefile)
	$(echo) "(constituents.make) Starting $@"
	@if test -f $(cmt_local_check_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_binaries_makefile) install; \
	  fi
#	@-$(MAKE) -f $(cmt_local_check_install_binaries_makefile) install
	$(echo) "(constituents.make) $@ done"

uninstall : check_install_binariesuninstall

$(foreach d,$(check_install_binaries_dependencies),$(eval $(d)uninstall_dependencies += check_install_binariesuninstall))

check_install_binariesuninstall : $(check_install_binariesuninstall_dependencies) ##$(cmt_local_check_install_binaries_makefile)
	$(echo) "(constituents.make) Starting $@"
	@-if test -f $(cmt_local_check_install_binaries_makefile); then \
	  $(MAKE) -f $(cmt_local_check_install_binaries_makefile) uninstall; \
	  fi
#	@$(MAKE) -f $(cmt_local_check_install_binaries_makefile) uninstall
	$(echo) "(constituents.make) $@ done"

remove_library_links :: check_install_binariesuninstall ;
...
cmt_local_tagfile_find_packages = $(bin)$(TrigCostPython_tag)_find_packages.make
...
cmt_local_tagfile_find_packages = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_compile = $(bin)$(TrigCostPython_tag)_compile.make
...
cmt_local_tagfile_compile = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_compile_pkg = $(bin)$(TrigCostPython_tag)_compile_pkg.make
...
cmt_local_tagfile_compile_pkg = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(TrigCostPython_tag)_new_analysisapp.make
...
cmt_local_tagfile_new_analysisapp = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_pkg = $(bin)$(TrigCostPython_tag)_new_pkg.make
...
cmt_local_tagfile_new_pkg = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_alg = $(bin)$(TrigCostPython_tag)_new_alg.make
...
cmt_local_tagfile_new_alg = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(TrigCostPython_tag)_new_analysisalg.make
...
cmt_local_tagfile_new_analysisalg = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_asgtool = $(bin)$(TrigCostPython_tag)_new_asgtool.make
...
cmt_local_tagfile_new_asgtool = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_jobo = $(bin)$(TrigCostPython_tag)_new_jobo.make
...
cmt_local_tagfile_new_jobo = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_new_skeleton = $(bin)$(TrigCostPython_tag)_new_skeleton.make
...
cmt_local_tagfile_new_skeleton = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_make_skeleton = $(bin)$(TrigCostPython_tag)_make_skeleton.make
...
cmt_local_tagfile_make_skeleton = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(TrigCostPython_tag)_checkout_pkg.make
...
cmt_local_tagfile_checkout_pkg = $(bin)$(TrigCostPython_tag).make
...
cmt_local_tagfile_cppcheck = $(bin)$(TrigCostPython_tag)_cppcheck.make
...
cmt_local_tagfile_cppcheck = $(bin)$(TrigCostPython_tag).make
