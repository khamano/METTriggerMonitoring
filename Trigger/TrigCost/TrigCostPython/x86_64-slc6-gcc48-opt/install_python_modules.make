...
#cmt_local_tagfile_install_python_modules = $(TrigCostPython_tag)_install_python_modules.make
...
#cmt_local_tagfile_install_python_modules = $(TrigCostPython_tag).make
...
#cmt_final_setup_install_python_modules = $(bin)TrigCostPython_install_python_modulessetup.make
...
#cmt_final_setup_install_python_modules = $(bin)TrigCostPythonsetup.make
cmt_local_install_python_modules_makefile = $(bin)install_python_modules.make
...
install_dir = ${installarea}/python/TrigCostPython
...
install_python_modulesinstall :: ${install_dir}/TrigCostCool.py ;

${install_dir}/TrigCostCool.py :: ../python/TrigCostCool.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../python/TrigCostCool.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "TrigCostCool.py" "$(install_dir)" "/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.3.5/AtlasCore/20.3.5/External/ExternalPolicy/src/symlink.sh" "$($(package)_cmtpath)"; \
	fi

../python/TrigCostCool.py : ;
...
install_python_modulesuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "TrigCostCool.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi
...
install_python_modulesinstall :: ${install_dir}/TrigCostTRP_save20121007.py ;

${install_dir}/TrigCostTRP_save20121007.py :: ../python/TrigCostTRP_save20121007.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../python/TrigCostTRP_save20121007.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "TrigCostTRP_save20121007.py" "$(install_dir)" "/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.3.5/AtlasCore/20.3.5/External/ExternalPolicy/src/symlink.sh" "$($(package)_cmtpath)"; \
	fi

../python/TrigCostTRP_save20121007.py : ;
...
install_python_modulesuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "TrigCostTRP_save20121007.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi


install_python_modulesinstall :: ${install_dir}/TrigCostXML.py ;

${install_dir}/TrigCostXML.py :: ../python/TrigCostXML.py
	@if test ! "${installarea}" = ""; then \
	  d=`dirname ../python/TrigCostXML.py`; \
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_install_action) "$${d}" "TrigCostXML.py" "$(install_dir)" "/cvmfs/atlas.cern.ch/repo/sw/software/x86_64-slc6-gcc48-opt/20.3.5/AtlasCore/20.3.5/External/ExternalPolicy/src/symlink.sh" "$($(package)_cmtpath)"; \
	fi

../python/TrigCostXML.py : ;
...
install_python_modulesuninstall ::
	@if test ! "${installarea}" = ""; then \
	  ...
	  d=`(cd $${d}; pwd)`; \
	  CMTINSTALLAREA=${CMTINSTALLAREA}; export CMTINSTALLAREA; \
	  $(cmt_uninstall_action) "$${d}" "TrigCostXML.py" "$(install_dir)" "$($(package)_cmtpath)"; \
	fi
